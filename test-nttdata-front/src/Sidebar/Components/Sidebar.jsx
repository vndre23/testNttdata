    ...
    <>
        <div style={{height: '100vh', overflow:'hidden'}}>
            <div className='min-h-screen flex relative lg:static surface-ground' >
                <div className='h-screen hidden lg:block flex-shrink-0 absolute lg:static left-0 top-0 z-1 select-none' style={{width:'280px',backgroundColor:"#805AD5"}}>
                    <div className='flex flex-column h-full'>
                        ...
                        <div className='overflow-y-auto mt-3'>
                            <ul className='list-none p-3 m-0'>
                                <a className='p-ripple flex align-items-center cursor-pointer p-3 hover:bg-purple-800 border-round text-bluegray-100 hover:text-bluegray-50 transition-duration-150 transition-colors w-full'>
